...
a.weight,
a.XRATE,
((a.PHYSICAL*a.UFACTOR)*a.XRATE) AS PPHYSICAL,
((a.ALLOCATION*a.UFACTOR)*a.XRATE) AS PALLOCATION,
((a.FREE*a.UFACTOR)*a.XRATE) AS PFREE,
((a.STOCKORDER*a.UFACTOR)*a.XRATE) AS PSTOCKORDER,
(b.CONSUMPTION*a.UFACTOR) as ANNUALCONSUMPTION,
(a.PHYSICAL*a.UFACTOR) as PHYSICAL1,
(a.ALLOCATION*a.UFACTOR) as ALLOCATION1,
((((a.STOCKORDER*a.UFACTOR)+(a.PHYSICAL*a.UFACTOR))-(a.ALLOCATION*a.UFACTOR))*a.XRATE) AS PKMDIVALUE,
