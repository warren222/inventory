...
declare @cancelalloc as decimal(10,2)=(select  COALESCE(sum(qty),0) from trans_tb where stockno ='" & stock & "' and reference = '" & ref & "'  and jo = '" & jo & "' AND TRANSTYPE='CancelAlloc')+0
    ...
    Private Sub KryptonButton1_Click(sender As Object, e As EventArgs) Handles KryptonButton1.Click
        If Form1.nickname.Text = "Noreen" Or Form1.accounttype.Text = "Admin" Or Form1.nickname.Text = "Joy" Or (Form1.nickname.Text = "jayson" And transtype.Text = "Allocation") Then
