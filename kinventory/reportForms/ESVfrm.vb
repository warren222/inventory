...
Public Class ESVfrm
    Private Sub ESVfrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub ESVfrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Me.ReportViewer1.RefreshReport()
    End Sub
End Class